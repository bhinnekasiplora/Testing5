        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="form-group">
              <label for="inputAddress">Jenis Bencana</label>
              <input type="text" class="form-control" id="inputAddress" placeholder="Jenis Bencana">
            </div>
            <div class="form-group">
              <label for="inputAddress2">Kode pos</label>
              <input type="text" class="form-control" id="inputAddress2" placeholder="Kode Pos">
            </div>
            <div class="form-group">
           ...
           <form>
            <a href="/pesanlaporan" class="btn btn-primary">Lapor</a>
          </form>
            </form>
          </div>
        </div>
