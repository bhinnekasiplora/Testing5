        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <form>
              <div class="form-row">
                <div class="col">
                  <h5>Rekapitulasi Nasional</h5>
                  Dari:<br> 
                  <input type="date" name="bday" class="form-control"><br>
                  Sampai:<br>
                  <input type="date" name="bday" class="form-control"><br>
                  <br>
                  <button type="button" class="btn btn-primary btn-sm">Lihat Rekapitulasi</button>
                </div>

                <div class="col">
                  <h5>Rekapitulasi Daerah</h5>
                  Daerah:<br>
