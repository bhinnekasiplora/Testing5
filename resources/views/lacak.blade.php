...
<!--         </button>
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/index">User</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
    ...
    <section id="contac">
      <div class="container">
        <hr>
        <h2 class="text-center text-uppercase text-secondary mb-0">Lacak Laporan Anda</h2>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <form name="sentMessage" id="contactForm" novalidate="novalidate">
              <h3 class="controls mb-0 pb-2">Lacak Dengan Kode</h3>
              <form>
              <div class="form-group col-md-6">
                <label for="inputEmail4">Kode Laporan</label>
                <input type="name" class="form-control" id="inputEmail4" placeholder="Kode Laporan">
              </div>
              <div class="form-group col-md-6">
           ...
           <form>
            <a href="/ceklaporan" class="btn btn-primary">Cek Laporan</a>
          </form>
            </form>
          </div>
        </div>
